...
def payments(request):
    ...
    # send order number and transection id back to sendData method via jsonResponse
    data = {
...
def place_order(request, total=0, quantity=0):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # fix this order_total with grand_total
            ...
            context = {
                'order': order, 'cart_items': cart_items, 'total': total, 'tax': tax, 'grand_total': grand_total,
            }
...
def order_complete(request):
    ...
    try:
        ...
        context = {
            ...
            'transID': payment.payment_id, 'payment': payment, 'subtotal': subtotal
        }
